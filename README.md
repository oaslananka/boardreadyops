...
The current public npm package is `boardreadyops@1.68.2`. It is verified on
Node.js 22.14+ and 24, includes the current CLI bundle, schemas, docs, Action
metadata, and matches the public `v1.68.2` tag archive.
Binary release assets should be verified against `v1.68.2`, which publishes the
