...
The current public npm package is `boardreadyops@1.39.0`. It is verified on
Node.js 22.14+ and 24, includes the current CLI bundle, schemas, docs, Action
metadata, and matches the public `v1.39.0` tag archive.
Binary release assets should be verified against `v1.39.0`, which publishes the
