...
const allowedLayers = new Map([
  ...
  [
    "cli",
    new Set(["cli", "core", "generated", "i18n", "kicad", "multicad", "release", "report", "runner", "util", "vendor"]),
  ],
  ["core", new Set(["core", "generated", "multicad", "notifiers", "rules", "util", "vendor"])],
  ["generated", new Set(["generated"])],
  ["firmware", new Set(["firmware", "util"])],
  ["i18n", new Set(["i18n"])],
  ["kicad", new Set(["bom", "kicad", "util"])],
  ["multicad", new Set(["bom", "multicad", "util"])],
  ...
  ["rules", new Set(["bom", "core", "firmware", "kicad", "multicad", "pinmap", "rules", "util", "vendor"])],
  ["types", new Set(["types"])],
  ["util", new Set(["util"])],
