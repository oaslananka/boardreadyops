...
const glossaryTerms = [
  ...
  },
  {
    ...
    definition:
      "The fabrication and assembly deliverables required by the chosen handoff: Gerbers, drill data, BOM, position files, and drawings. BoardReadyOps can generate these through boardreadyops generate (wrapping kicad-cli) or validate the outputs generated by your existing toolchain.",
  },
  {
...
const releaseFaq = [
  {
    ...
    answer:
      "You can generate them with BoardReadyOps or bring your own. Use 'boardreadyops generate' to produce Gerbers, drill files, BOM, and position files directly via kicad-cli, or keep your existing KiBot/export pipeline. BoardReadyOps validates that the package is complete, current, and matches the evaluated commit before you order boards.",
  },
  {
