  ...
  return (
    <AppShell viewerNav={<ViewerNav />}>
      <main className="shell" id="main-content">
        <Breadcrumbs items={[{ href: "/", label: "Home" }, { label: "Component intelligence" }]} />
        <header className="page-heading">
          ...
          <p>
            ...
            <strong>your own provider account</strong>, not a shared BoardReadyOps subscription, because provider
            licences are non-transferable — one customer&apos;s answer may not be reused for another.
          </p>
        </header>
              ...
              <Panel key={installation.id} title={installation.accountLogin}>
                <DefinitionGrid>
                  ...
                  <Definition label="Credential">
                    {installation.hasComponentCredential ? "Stored" : "Not set"}
                  </Definition>
                </DefinitionGrid>
        ...
        <Panel title="What we store">
          <p>
            Only the credential you enter, encrypted, and whether the provider last refused it. The secret is never
            shown again and never appears in a page, a log line, or an error message. Removing it stops all lookups for
            that installation immediately; your recorded board evidence is untouched.
          </p>
          <p>
