...
* resolve issue [#839](https://github.com/oaslananka/boardreadyops/issues/839) ([#840](https://github.com/oaslananka/boardreadyops/issues/840)) ([bc09198](https://github.com/oaslananka/boardreadyops/commit/bc09198b6c4f475a7e07ca6351f6eee021b9b0d9))
...
* **web:** stop the review search field collapsing to nothing ([#733](https://github.com/oaslananka/boardreadyops/issues/733)) ([7de4e57](https://github.com/oaslananka/boardreadyops/commit/7de4e57ced3f405599ee17b8397c11d8fe1d17e3))
...
* **bom:** turn /parts into a real component inventory ([#667](https://github.com/oaslananka/boardreadyops/issues/667)) ([73718c7](https://github.com/oaslananka/boardreadyops/commit/73718c7c42a9cae1003429f6a6a6c12302cfd714))
...
* **cloud:** github capability model and safe mutation foundation (PR 1) ([#686](https://github.com/oaslananka/boardreadyops/issues/686)) ([e618967](https://github.com/oaslananka/boardreadyops/commit/e61896707899b09460cb829766b4076e3c133f86))
* **cloud:** let a tenant read their own audit log ([#679](https://github.com/oaslananka/boardreadyops/issues/679)) ([69f15c1](https://github.com/oaslananka/boardreadyops/commit/69f15c147977899ff1fa7078d3f8130653b426be))
* **cloud:** let a workspace have more than one person in it ([#677](https://github.com/oaslananka/boardreadyops/issues/677)) ([5c43423](https://github.com/oaslananka/boardreadyops/commit/5c43423bceb74c9b9db4c15619714aa91408f341))
* **cloud:** make /deliveries show and issue the guest links it names ([#672](https://github.com/oaslananka/boardreadyops/issues/672)) ([c0a289d](https://github.com/oaslananka/boardreadyops/commit/c0a289d5e16ef3b8adae9544dfa1283a6a1cdc62))
* **cloud:** one-click repository setup and remediation pr engine (PR 2) ([#687](https://github.com/oaslananka/boardreadyops/issues/687)) ([592923a](https://github.com/oaslananka/boardreadyops/commit/592923ac3397a1c51cdaa9f1efb7f38771fc8339))
* **cloud:** review and workflow-aware lifecycle webhooks and hooks ([#690](https://github.com/oaslananka/boardreadyops/issues/690)) ([19fd05f](https://github.com/oaslananka/boardreadyops/commit/19fd05f4c513f71f4ca9efc1baa6f0bbb238af1a))
...
* **evidence:** show the real evidence ledger instead of describing one ([#666](https://github.com/oaslananka/boardreadyops/issues/666)) ([1865346](https://github.com/oaslananka/boardreadyops/commit/18653464d797d26c331c9b345f81a6bc14d536fa))
...
* **rules:** show the 44 checks the engine runs ([#676](https://github.com/oaslananka/boardreadyops/issues/676)) ([38c50a4](https://github.com/oaslananka/boardreadyops/commit/38c50a407928034bc109b9151464b06a1cc6bf7c))
...
* **web:** premium UI — new brand, design system, and real data behind the settings and review surfaces ([#657](https://github.com/oaslananka/boardreadyops/issues/657)) ([899c39a](https://github.com/oaslananka/boardreadyops/commit/899c39ad5896e35fdaf0f79197cd4bb509930a66))
...
* **action:** give the action the token its own defaults need ([#671](https://github.com/oaslananka/boardreadyops/issues/671)) ([7a72a8f](https://github.com/oaslananka/boardreadyops/commit/7a72a8f3f08d52c83c9ce36aef43249ceb7d7d2d))
* **ci:** bound production build cache growth ([#682](https://github.com/oaslananka/boardreadyops/issues/682)) ([19b0ff7](https://github.com/oaslananka/boardreadyops/commit/19b0ff7c117e9465be7fdfdc7e07b80f6ffc180c))
...
* **ci:** retire superseded runtime images so the deploy host stops growing ([#670](https://github.com/oaslananka/boardreadyops/issues/670)) ([79c28d5](https://github.com/oaslananka/boardreadyops/commit/79c28d582702de28d6fb80f191619f082b84fd91))
* **ci:** stop cloud-deploy from building into a full disk ([#662](https://github.com/oaslananka/boardreadyops/issues/662)) ([56167cc](https://github.com/oaslananka/boardreadyops/commit/56167cc1fa1e83b6af41a83219be3d72e5fa4d0b))
* **cloud:** clear the SonarCloud and Codecov findings on this branch ([#668](https://github.com/oaslananka/boardreadyops/issues/668)) ([0aa7b50](https://github.com/oaslananka/boardreadyops/commit/0aa7b50133053b07d5cbad10981725cf9e729f48))
* **cloud:** drop the anchored alternation, and stop a test that could pass vacuously ([#669](https://github.com/oaslananka/boardreadyops/issues/669)) ([0d2862e](https://github.com/oaslananka/boardreadyops/commit/0d2862eea2295adc799dd206662ec2b79d67a59b))
* **cloud:** scope the v2 workspace API to the caller's own workspaces ([#659](https://github.com/oaslananka/boardreadyops/issues/659)) ([15a7f31](https://github.com/oaslananka/boardreadyops/commit/15a7f31dfd5e4514a3434e60ab4942f2f2cea79b))
...
* **docs:** clarify GitHub App permission updates ([#684](https://github.com/oaslananka/boardreadyops/issues/684)) ([aa516bd](https://github.com/oaslananka/boardreadyops/commit/aa516bd1f3e3ab71daf1013926846c9d2f042bbb))
...
* **docs:** generate the rule reference from the registry, not a copy of it ([#673](https://github.com/oaslananka/boardreadyops/issues/673)) ([b2ae2f1](https://github.com/oaslananka/boardreadyops/commit/b2ae2f120c0126f7cfcb60cd0ec4d4cb96717dac))
* **docs:** reject stale canary workflow pins ([#683](https://github.com/oaslananka/boardreadyops/issues/683)) ([026de21](https://github.com/oaslananka/boardreadyops/commit/026de21464ba86c6924ae48194a80d63b7b9a479))
* **docs:** unbreak docs-build, and say which token broke it ([#664](https://github.com/oaslananka/boardreadyops/issues/664)) ([253e540](https://github.com/oaslananka/boardreadyops/commit/253e540728cc0671e648a90e8ad716ba78352052))
...
* **web:** give every control a 44px touch target, and clear the last two Sonar findings ([#660](https://github.com/oaslananka/boardreadyops/issues/660)) ([bfcad0f](https://github.com/oaslananka/boardreadyops/commit/bfcad0fd9744d4115e15ec04590a5dce344f3c33))
...
* **web:** keep setup YAML rows stable ([#681](https://github.com/oaslananka/boardreadyops/issues/681)) ([dab9e0b](https://github.com/oaslananka/boardreadyops/commit/dab9e0b1320880ab20875841d779aea55a9fef25))
...
* **web:** return 404 for missing records, and clear the SonarCloud findings on [#657](https://github.com/oaslananka/boardreadyops/issues/657) ([#658](https://github.com/oaslananka/boardreadyops/issues/658)) ([ba57c4d](https://github.com/oaslananka/boardreadyops/commit/ba57c4d9eb284a97f16626fe3851119cb067ec5e))
...
* **web:** stop seven pages scrolling sideways on phones and tablets ([#661](https://github.com/oaslananka/boardreadyops/issues/661)) ([82a691c](https://github.com/oaslananka/boardreadyops/commit/82a691cbad6e9d7447976840f41694448d09eb90))
...
* **cloud:** add order-independent decision fingerprint ([#572](https://github.com/oaslananka/boardreadyops/issues/572)) ([9451f07](https://github.com/oaslananka/boardreadyops/commit/9451f071b9ccb7e1b7dda18149f569fb32bf4ef0))
* **contracts:** add snapshot guard against silent public schema drift ([#568](https://github.com/oaslananka/boardreadyops/issues/568)) ([e514fb0](https://github.com/oaslananka/boardreadyops/commit/e514fb08c92a7fbb049fff80ed902ab1bb7ca03d))
...
* **core:** strip a leading UTF-8 BOM when reading text files ([#575](https://github.com/oaslananka/boardreadyops/issues/575)) ([a8bce03](https://github.com/oaslananka/boardreadyops/commit/a8bce0365b5870202e8d0bf82d2998a0f5fa221f))
* **deps:** pin browserslist past GHSA high-severity advisory ([#567](https://github.com/oaslananka/boardreadyops/issues/567)) ([26aa9c7](https://github.com/oaslananka/boardreadyops/commit/26aa9c74bda8bd59aca725a0c3bda311c065a4bd))
