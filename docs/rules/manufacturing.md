...
- [manufacturing.paste-coverage](manufacturing.paste-coverage.md): Checks that each side carrying surface-mount assembly in the Gerber package has a matching solder paste layer.
