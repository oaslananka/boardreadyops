...
Repositories containing multiple KiCad fixtures or projects can set the non-secret repository variable `BOARDREADYOPS_PROJECT` to one project directory or `.kicad_pro` path. When unset, BoardReadyOps scans every discovered project.
