...
- **Code & Test Evidence:** `src/rules/drc/`, `src/rules/erc/`, `src/rules/manufacturing/`, `src/core/rule-registry.ts`, `src/core/waivers.ts`, `src/core/pipeline.ts`, `tests/unit/rules/metadata.test.ts`, `tests/unit/core/waivers.test.ts`.
