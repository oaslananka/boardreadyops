...
> **Current status:** The latest public release is `boardreadyops@1.60.1` on npm
> and the `v1.60.1` GitHub Release. The exact release tag and floating `v1` tag
...
| --- | --- |
| Public release | `v1.60.1` |
| npm package | `boardreadyops@1.60.1` (`latest`) |
...
| Container aliases | `v1.60.1`, `v1`, and `latest` |
