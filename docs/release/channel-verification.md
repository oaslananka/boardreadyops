...
> **Current status:** The latest public release is `boardreadyops@1.38.0` on npm
> and the `v1.38.0` GitHub Release. The exact release tag and floating `v1` tag
...
| --- | --- |
| Public release | `v1.38.0` |
| npm package | `boardreadyops@1.38.0` (`latest`) |
...
| Container aliases | `v1.38.0`, `v1`, and `latest` |
