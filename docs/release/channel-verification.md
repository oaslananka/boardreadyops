...
> **Current status:** The latest public release is `boardreadyops@1.68.2` on npm
> and the `v1.68.2` GitHub Release. The exact release tag and floating `v1` tag
...
| --- | --- |
| Public release | `v1.68.2` |
| npm package | `boardreadyops@1.68.2` (`latest`) |
...
| Container aliases | `v1.68.2`, `v1`, and `latest` |
