...
> **Current status:** The latest public release is `boardreadyops@1.31.6` on npm
> and the `v1.31.6` GitHub Release. The exact release tag and floating `v1` tag
...
| --- | --- |
| Public release | `v1.31.6` |
| npm package | `boardreadyops@1.31.6` (`latest`) |
...
| Container aliases | `v1.31.6`, `v1`, and `latest` |
