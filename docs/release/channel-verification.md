...
> **Current status:** The latest public release is `boardreadyops@1.41.5` on npm
> and the `v1.41.5` GitHub Release. The exact release tag and floating `v1` tag
...
| --- | --- |
| Public release | `v1.41.5` |
| npm package | `boardreadyops@1.41.5` (`latest`) |
...
| Container aliases | `v1.41.5`, `v1`, and `latest` |
