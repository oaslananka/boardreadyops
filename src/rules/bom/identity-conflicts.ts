...
export const identityConflictsRule = rule(
  ...
  async (context) => {
    ...
    return [
      ...checkBomInternalConflicts(context, bomRows),
      ...checkBomSchematicConflicts(context, bomRows, schematicRows),
    ];
  },
);

function checkBomInternalConflicts(context: RuleContext, bomRows: BomRow[]) {
  const findings = [];
...
function checkBomSchematicConflicts(context: RuleContext, bomRows: BomRow[], schematicRows: BomRow[]) {
